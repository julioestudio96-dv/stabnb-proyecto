...
const MyBookings = () => {
    ...
    const fetchAllBookings = async () => { // <--- 1. Creamos una función interna async
        ...
        try {
            // 2. Necesitas obtener la sesión primero para tener el ID del usuario
            ...
            // 4. Traemos las propiedades de la DB
    ...
    fetchAllBookings(); // <--- 6. Llamamos a la función
}, []);
    ...
    return (
        <div className="min-h-screen bg-white flex flex-col font-sans">
            ...
            <main className="grow max-w-5xl mx-auto w-full px-4 py-10">
                ...
                <h1 className="text-3xl font-bold mb-8 mt-2 italic text-gray-800">Mis viajes</h1>
                            ...
                            <div key={item.id} className="relative flex flex-col md:flex-row border border-gray-200 rounded-3xl overflow-hidden shadow-sm bg-white p-5 gap-6 group transition-all hover:shadow-md">
                                ...
                                <div className="flex-1 flex flex-col justify-between py-1">
                                    <div>
                                        ...
                                        {/* SECCIÓN ACTUALIZADA CON HUÉSPEDES */}
                                        <div className="mt-5 flex flex-wrap gap-8 text-sm border-t border-gray-50 pt-4">
                                    ...
                                    <div className="flex justify-between items-end mt-4">
                                        <div>
                                            ...
                                            <p className="text-2xl font-black text-rose-500">${parseFloat(item.total_price).toLocaleString('es-CO')}</p>
                                        </div>
